module RailsJwtAuth
  module Invitable
    ...
    def accept_invitation!
      ...
      if valid_invitation?
        accept_invitation
        self.confirmed_at = Time.current.utc if respond_to?(:confirmed_at) && confirmed_at.nil?
      else
    ...
    def invite!
      self.invitation_created_at = Time.current.utc if new_record?
      ...
      self.invitation_sent_at = Time.current.utc
